...
export default function NewStudentPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (nis.trim() && className.trim() && name.trim()) {
